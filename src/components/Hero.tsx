      ...
      <div className="container px-4 mx-auto max-w-6xl">
        ...
        >
          <motion.div variants={item}>
            <h1 className="text-5xl md:text-7xl font-display font-bold tracking-tight mb-6 text-balance">
              Build thriving communities with passion
            </h1>
          </motion.div>
          <motion.div variants={item}>
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto mb-10 text-balance">
              Create, grow, and monetize your knowledge community with our seamless platform that connects experts with eager learners.
            </p>
          </motion.div>
          <motion.div 
            variants={item}
        ...
        >
          <div className="relative mx-auto max-w-5xl">
            ...
            {/* Floating elements */}
            <motion.div 
              className="absolute -top-8 -right-8 w-36 h-36 glass rounded-xl shadow-lg border border-white/20 p-3"
              animate={{ 
                y: [0, -15, 0], 
                rotate: [0, 2, 0],
                transition: { 
            ...
            <motion.div 
              className="absolute -left-6 bottom-12 w-32 h-32 glass rounded-xl shadow-lg border border-white/20 flex flex-col p-3"
              animate={{ 
                y: [0, 15, 0], 
                rotate: [0, -2, 0],
                transition: { 
